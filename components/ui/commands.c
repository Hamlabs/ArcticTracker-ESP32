 ...
 * 
 * Modified help function - by LA7ECA Øyvind Hanssen
 */
...
/* Print hint and arguments for a single command */
static void print_item_help(const cmd_item_t *it)
{
    if (it->help == NULL) {
        return;
    }
...
esp_err_t esp_console_register_help_command(void)
{
    esp_console_cmd_t command = {
        .command = "help",
        .help = "Print info about given command OR list of registered commands",
        .hint = "[<command>]",
        .func = &help_command
    };
