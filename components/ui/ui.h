...
#define BLINK_NORMAL        {blink_length=500;blink_interval=500;}
#define BLINK_GPS_SEARCHING {blink_length=20;blink_interval=1000;}
#define BLINK_FWUPGRADE     {blink_both=true;blink_length=40;blink_interval=40;}
